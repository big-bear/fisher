...
function initSeletList() {
	...
	for (var i = 0; i < provinces.length; i++) {
		...
		document.getElementById("s_province").appendChild(op);
	}
}
/*下拉列表选项改变时执行此函数*/
function changeSelect(element) {
	...
	if (id == "s_province" && element.value != "000000") {
		document.getElementById("s_city").options.length = 1; //清除市下拉列表旧选项  
		...
		if (pCode != 0) {
			for (var i = 0; i < cities.length; i++) {
				if (cities[i].ProvinceCode() == pCode) {
					...
					document.getElementById("s_city").appendChild(op);
				}
			}
		}
		document.getElementById("s_county").options.length = 1; //清除区下拉列表旧选项  
		var cCode = parseInt(document.getElementById("s_city").value); //获取市下拉列表被选中项的市编码  
		/*根据市编码更新区下拉列表*/
		if (cCode != 0) {
			for (var i = 0; i < districts.length; i++) {
				if (districts[i].CityCode() == cCode) {
					...
					document.getElementById("s_county").appendChild(op);
				}
			}
		}
	}
	/*市下拉列表改变时更新区下拉列表的选项*/
	if (id == "s_city" && element.value != "000000") {
		document.getElementById("s_county").options.length = 1; //清除区下拉列表旧选项  
